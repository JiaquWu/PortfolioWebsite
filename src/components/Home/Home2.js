            ...
            <Container>
                <Row className="align-items-baseline">
                    <Col md={8} className="home-about-description">
                        ...
                        <p className="locomoto-intro-desc white-text">
                            In the past 7 years, I've continuously developed my understanding and proficiency with <b className="purple">C# and Unity</b>. And I've become comfortable using them to implement various gameplay features, game systems, and custom tools. 
                        ...
                        <p className="locomoto-intro-desc white-text">
                            ...
                            Apart from that, I love helping other developers with quickly resolving miscellaneous issues for them in day-to-day development, and developing custom tools to support my team.I'm always into complex game systems, various tools and plugins to solve technical issues and challenges, and I long to push my skills further in the fantastic world of game development step by step.
                        </p>
                        {/*<p className="locomoto-intro-desc white-text">*/}
