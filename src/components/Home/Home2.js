                ...
                <Row className="align-items-baseline">
                    <Col md={8} className="home-about-description">
                        ...
                        <p className="locomoto-intro-desc white-text">
                            ...
                            From <strong>2025</strong> to <strong>2026</strong>, I studied Game Programming at <a href="https://futuregames.se/program/game-programmer-specialization-stockholm/" className="purple bold-link"> FutureGames</a> while continuing to develop games with former colleagues outside of school, primarily through our announced game <a href="https://store.steampowered.com/app/4193660/Goblin_Getaway/" className="purple bold-link">Goblin Getaway</a>. I am now focused on this work full-time, collaborating with the team to explore new gameplay ideas, production approaches, and creative possibilities.
                        </p>

                        {/* —— Skills & Expertise —— */}
                        <h2 className="section-heading">Skills &amp; Expertise</h2>
                        <p className="locomoto-intro-desc white-text">
                            In the past <b className="purple">8 years</b>, I've continuously developed my understanding and proficiency with <b className="purple">C#</b> and<b className="purple"> Unity</b>. And I've become comfortable using them to implement various gameplay features, game systems, and custom tools. 
