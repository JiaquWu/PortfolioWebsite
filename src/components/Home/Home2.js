            ...
            <Container>
                <Row className="align-items-baseline">
                    <Col md={8} className="home-about-description">
                        ...
                        <p className="locomoto-intro-desc white-text">
                            In the past 7 years, I've continuously developed my understanding and proficiency with <b className="purple">C#</b> and<b className="purple"> Unity</b>. And I've become comfortable using them to implement various gameplay features, game systems, and custom tools. 
