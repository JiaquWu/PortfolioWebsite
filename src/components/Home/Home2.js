      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            During the last two years of my studies in Sweden, I worked as game programmer on a few <a href="/project" className="purple">game projects</a> and had the opportunity to intern as a game programmer at a studio that makes commercial games. 
