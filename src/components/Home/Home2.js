            ...
            <Container>
                <Row className="align-items-baseline">
                    <Col md={8} className="home-about-description">
                        ...
                        <p className="locomoto-intro-desc white-text">
                            In <strong>2020</strong>, I moved to Sweden to further pursue this passion professionally. During my two years of studies here, I contributed as a game programmer to several game projects and had the opportunity to intern at <a href="https://www.blackdropinteractive.com/" className="purple bold-link"> Blackdrop Interactive</a>, where I made contributions to <a href="https://store.steampowered.com/app/1129310/Receiver_2/" className="purple bold-link">Receiver 2</a>. After completing my studies, I joined <a href="https://greentiledigital.com/" className="purple bold-link"> Green Tile Digital</a> and spent more than two years as a <b className="purple">Gameplay Programmer</b> on <a href="https://store.steampowered.com/app/2328650/Locomoto/" className="purple bold-link">Locomoto</a>
